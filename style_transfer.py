...
class StyleAugment:
    ...
    def __init__(self, n_images_per_style=10, L=0.1, size=(1024, 512), b=None):
        ...
        self.sizes = None
        self.cv2 = False
        self.b = b #num di pxls = metà del lato della finestra
    ...
    #Preso un dataloader, aggiunge uno stile alla banca degli stili (self.styles)
    def add_style(self, loader, multiple_styles=False, name=None):
        ...
        for sample, _ in tqdm(loader, total=min(len(loader), self.n_images_per_style)):
            ...
            n += 1
        #Qui viene calcolato lo stile medio per ogni cliente
